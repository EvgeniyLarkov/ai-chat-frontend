...
class ChatReactions {
	...
	byName: {
		[WsServerChatEvents.message]: InstanceType<
			typeof ChatReactions
		>['handleMessageReaction'];
		[WsServerChatEvents.getOnline]: InstanceType<
			typeof ChatReactions
		>['handleIsOnlineReaction'];
		[WsServerChatEvents.typing]: InstanceType<
			typeof ChatReactions
		>['handleTypingReaction'];
	};
	...
	constructor(chatStorage: Chat) {
		...
		this.byName = {
			[WsServerChatEvents.message]: this.handleMessageReaction,
			[WsServerChatEvents.getOnline]: this.handleIsOnlineReaction,
			[WsServerChatEvents.typing]: this.handleTypingReaction,
		};
	}

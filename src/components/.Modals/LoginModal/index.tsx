    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Input prefix={<UserOutlined className="site-form-item-icon" />} placeholder={t('login.email')} />
                </Form.Item>
                <Form.Item
                    name="password"
                    rules={[
                ...
                <Form.Item>
                    ...
                    <div>
                        Or <Button onClick={onRegisterClick} type="link">{t('login.register')}</Button>
                    </div>
                </Form.Item>
            </Form>
        </Modal>
